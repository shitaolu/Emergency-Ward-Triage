...
public class testPatientTriage {
    public static void main(String[] args) throws BoundaryViolationException, EmptyQueueException {
        ...
        System.out.println(patient);
        Patient p1 = new Patient(1000, 1, new Time(0, 0));
	Patient p2 = new Patient(2000, 2, new Time(0, 0));
	PatientPriorityComparator comparator = new PatientPriorityComparator();
	System.out.print(comparator.compare(p1, p2)); // Failure. Expected <-1> but was: <1>
